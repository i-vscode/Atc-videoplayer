 ...
 * @returns
 */
export declare const isProcessor: (processor: unknown) => processor is Processor;
 ...
 * @returns
 */
export declare const isProcessorFactory: (processorFactory: unknown) => processorFactory is ProcessorFactory;
