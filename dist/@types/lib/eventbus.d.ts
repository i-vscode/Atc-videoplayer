...
export declare const eventbus: {
    new <T>(): {
        "__#9@#Mpa": Map<any, Set<(...args: any) => void>>;
        /** 添加事件 */
        on(eventname: T, fn: (...args: any) => void): void;
        /** 删除事件 */
        off(eventname: T, fn: (...args: any) => void): void;
        /** 触发事件 */
        trigger(eventname: T, ...params: any[]): void;
    };
};
/**  VidoeDash 事件类型 */
export declare enum VidoeDashEventType {
    /** 当目前的播放位置已更改时触发。*/
