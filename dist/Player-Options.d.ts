...
export declare class PlayerOptions {
    ...
    /**  转换过期时间  (秒) */
    convertExpiryTime: number;
    /** 源缓冲更新最小频率 (秒) */
    sourceBufferUpdateMinFrequency: number;
    /**
     * 分段文件 字符串转URL 的转换策略
     * @example
     ...
     * @deprecated  暂时未实现
     */
    convertStrategy: "InquireNow" | "BufferTime" | "MuchPossible";
    /**
     * 调度策略
     *  @example
     ...
     * @deprecated  暂时未实现
     */
    fetchScheduleStrategy: "Single" | "Group" | "Dynamic";
    constructor(p?: Partial<PlayerOptions>);
}
/**
 * 质量 枚举
 */
export declare enum QualityTab {
    Auto = "auto",
    P480 = "480P",
    P720 = "720P",
    P1080 = "1080P",
